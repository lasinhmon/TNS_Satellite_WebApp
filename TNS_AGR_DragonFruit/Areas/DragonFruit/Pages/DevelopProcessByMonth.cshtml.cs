...
namespace TNS_AGR.Areas.DragonFruit.Pages
{
    ...
    public class DevelopProcessByMonthModel : PageModel
    {
        #region [ Security ]
        ...
        public IActionResult OnPostLoadService([FromBody] ItemRequest request)
        {
            ...
            List<string[]> zData = Models.AccessData.GetDevelopProcessByWard(zYearView, zDistrict);
        ...
        public IActionResult OnPostCollectWard([FromBody] ItemRequest request)
        {
            CheckAuth();
            string zMessageLog = "";
            string zProvince = request.LocationID;
            List<string[]> zListDistrict = Models.AccessData.GetWardByDistrict(zProvince);
