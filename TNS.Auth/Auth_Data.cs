...
namespace TNS.Auth
{
    ...
    public class Securiry
    {
        ...
        {
            MessageError = "";
            string zSQL = "SELECT A.UserKey, A.UserName, A.Password,A.Activate,A.MemberKey,B.MemberID, B.LastName + ' ' + B.FirstName  AS MemberName "
                        + "FROM[dbo].[SYS_Users] A "
                        + "LEFT JOIN[dbo].[HRM_Member] B ON A.MemberKey = B.MemberKey "
